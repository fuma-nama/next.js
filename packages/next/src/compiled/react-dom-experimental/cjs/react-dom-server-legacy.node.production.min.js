...
integrity:b.integrity,type:b.type,nonce:b.nonce,fetchPriority:b.fetchPriority,imageSrcSet:b.imageSrcSet,imageSizes:b.imageSizes}},d.preloadsMap.set(f,g),z(g.chunks,g.props));switch(e){case "font":d.fontPreloads.add(g);break;case "style":d.explicitStylesheetPreloads.add(g);break;case "script":d.explicitScriptPreloads.add(g);break;default:d.explicitOtherPreloads.add(g)}cc(c)}}}
...
function de(a){if(2!==a.status){var b=$c,c=Xd.current;Xd.current=Vd;var d=Yd.current;Yd.current=Wd;var e=I;I=a;var f=Ud;Ud=a.responseState;try{var g=a.pingedTasks,h;for(h=0;h<g.length;h++){var k=g[h];var m=a,t=k.blockedBoundary;m.resources.boundaryResources=t?t.resources:null;var p=k.blockedSegment;if(0===p.status){fd(k.context);var T=p.children.length,O=p.chunks.length;try{var U=k.thenableState;k.thenableState=null;Z(m,k,U,k.node);m.responseState.generateStaticMarkup||p.lastPushedText&&p.textEmbedded&&
p.chunks.push("\x3c!-- --\x3e");k.abortSet.delete(k);p.status=1;ne(m,k.blockedBoundary,p)}catch(v){Hd();p.children.length=T;p.chunks.length=O;var F=v===od?sd():v;if("object"===typeof F&&null!==F&&"function"===typeof F.then){var G=k.ping;F.then(G,G);k.thenableState=Id()}else{k.abortSet.delete(k);p.status=4;var l=m,B=k.blockedBoundary,L=F,A=ee(l,L);null===B?fe(l,L):(B.pendingTasks--,B.forceClientRender||(B.forceClientRender=!0,B.errorDigest=A,B.parentFlushed&&l.clientRenderedBoundaries.push(B)));l.allPendingTasks--;
if(0===l.allPendingTasks){var P=l.onAllReady;P()}}}finally{m.resources.boundaryResources=null}}}g.splice(0,h);null!==a.destination&&pe(a,a.destination)}catch(v){ee(a,v),fe(a,v)}finally{Ud=f,Xd.current=c,Yd.current=d,c===Vd&&fd(b),I=e}}}
function qe(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;b.push('<template id="');b.push(a.placeholderPrefix);a=d.toString(16);b.push(a);return b.push('"></template>');case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)b.push(d[f]);e=re(a,b,e)}for(;f<d.length-1;f++)b.push(d[f]);f<d.length&&(e=b.push(d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function re(a,b,c){var d=c.boundary;if(null===d)return qe(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||(d=d.errorDigest,b.push("\x3c!--$!--\x3e"),b.push("<template"),d&&(b.push(' data-dgst="'),d=q(d),b.push(d),b.push('"')),b.push("></template>")),qe(a,b,c),a=a.responseState.generateStaticMarkup?!0:b.push("\x3c!--/$--\x3e"),a;if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=
e.nextSuspenseID++;e=e.boundaryPrefix+f.toString(16);d=d.id=e;Hb(b,a.responseState,d);qe(a,b,c);return b.push("\x3c!--/$--\x3e")}if(d.byteSize>a.progressiveChunkSize)return d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Hb(b,a.responseState,d.id),qe(a,b,c),b.push("\x3c!--/$--\x3e");(c=a.resources.boundaryResources)&&d.resources.forEach(dc,c);a.responseState.generateStaticMarkup||b.push("\x3c!--$--\x3e");c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
re(a,b,c[0]);a=a.responseState.generateStaticMarkup?!0:b.push("\x3c!--/$--\x3e");return a}function se(a,b,c){Ib(b,a.responseState,c.formatContext,c.id);re(a,b,c);return Jb(b,c.formatContext)}
function te(a,b,c){a.resources.boundaryResources=c.resources;for(var d=c.completedSegments,e=0;e<d.length;e++)ue(a,b,c,d[e]);d.length=0;Rb(b,c.resources,a.responseState);a=a.responseState;d=c.id;e=c.rootSegmentID;c=c.resources;var f=a.stylesToHoist;a.stylesToHoist=!1;var g=0===a.streamingFormat;g?(b.push(a.startInlineScript),f?0===(a.instructions&2)?(a.instructions|=10,b.push('$RC=function(b,c,e){c=document.getElementById(c);c.parentNode.removeChild(c);var a=document.getElementById(b);if(a){b=a.previousSibling;if(e)b.data="$!",a.setAttribute("data-dgst",e);else{e=b.parentNode;a=b.nextSibling;var f=0;do{if(a&&8===a.nodeType){var d=a.data;if("/$"===d)if(0===f)break;else f--;else"$"!==d&&"$?"!==d&&"$!"!==d||f++}d=a.nextSibling;e.removeChild(a);a=d}while(a);for(;c.firstChild;)e.insertBefore(c.firstChild,a);b.data="$"}b._reactRetry&&b._reactRetry()}};$RM=new Map;\n$RR=function(r,t,w){for(var u=$RC,n=$RM,p=new Map,q=document,g,b,h=q.querySelectorAll("link[data-precedence],style[data-precedence]"),v=[],k=0;b=h[k++];)"not all"===b.getAttribute("media")?v.push(b):("LINK"===b.tagName&&n.set(b.getAttribute("href"),b),p.set(b.dataset.precedence,g=b));b=0;h=[];var l,a;for(k=!0;;){if(k){var f=w[b++];if(!f){k=!1;b=0;continue}var c=!1,m=0;var d=f[m++];if(a=n.get(d)){var e=a._p;c=!0}else{a=q.createElement("link");a.href=d;a.rel="stylesheet";for(a.dataset.precedence=\nl=f[m++];e=f[m++];)a.setAttribute(e,f[m++]);e=a._p=new Promise(function(x,y){a.onload=x;a.onerror=y});n.set(d,a)}d=a.getAttribute("media");!e||"l"===e.s||d&&!matchMedia(d).matches||h.push(e);if(c)continue}else{a=v[b++];if(!a)break;l=a.getAttribute("data-precedence");a.removeAttribute("media")}c=p.get(l)||g;c===g&&(g=a);p.set(l,a);c?c.parentNode.insertBefore(a,c.nextSibling):(c=q.head,c.insertBefore(a,c.firstChild))}Promise.all(h).then(u.bind(null,r,t,""),u.bind(null,r,t,"Resource failed to load"))};$RR("')):
...
b.push('$RC("')):f?b.push('<template data-rri="" data-bid="'):b.push('<template data-rci="" data-bid="');if(null===d)throw Error("An ID must have been assigned before we can complete the boundary.");e=e.toString(16);b.push(d);g?b.push('","'):b.push('" data-sid="');b.push(a.segmentPrefix);b.push(e);f?g?(b.push('",'),$b(b,c)):(b.push('" data-sty="'),ac(b,c)):g&&b.push('"');d=g?b.push(")\x3c/script>"):b.push('"></template>');return Gb(b,a)&&d}
function ue(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return se(a,b,d)}se(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(b.push(a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,b.push('$RS=function(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};;$RS("')):
...
function pe(a,b){try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){var e=a.resources,f=a.responseState;if(0!==a.allPendingTasks&&f.externalRuntimeScript){var g=f.externalRuntimeScript,h=g.chunks,k="[script]"+g.src,m=e.scriptsMap.get(k);m||(m={type:"script",chunks:h,state:0,props:null},e.scriptsMap.set(k,m),e.scripts.add(m))}var t=f.htmlChunks,p=f.headChunks;g=0;if(t){for(g=0;g<t.length;g++)b.push(t[g]);if(p)for(g=0;g<p.length;g++)b.push(p[g]);else{var T=C("head");b.push(T);
b.push(">")}}else if(p)for(g=0;g<p.length;g++)b.push(p[g]);var O=f.charsetChunks;for(g=0;g<O.length;g++)b.push(O[g]);O.length=0;e.preconnects.forEach(Sb,b);e.preconnects.clear();var U=f.preconnectChunks;for(g=0;g<U.length;g++)b.push(U[g]);U.length=0;e.fontPreloads.forEach(Sb,b);e.fontPreloads.clear();e.precedences.forEach(Xb,b);e.scripts.forEach(Sb,b);e.scripts.clear();e.explicitStylesheetPreloads.forEach(Sb,b);e.explicitStylesheetPreloads.clear();e.explicitScriptPreloads.forEach(Sb,b);e.explicitScriptPreloads.clear();
e.explicitOtherPreloads.forEach(Sb,b);e.explicitOtherPreloads.clear();var F=f.preloadChunks;for(g=0;g<F.length;g++)b.push(F[g]);F.length=0;var G=f.hoistableChunks;for(g=0;g<G.length;g++)b.push(G[g]);G.length=0;t&&null===p&&(b.push("</"),b.push("head"),b.push(">"));re(a,b,d);a.completedRootSegment=null;Gb(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var l=a.resources,B=a.responseState;d=0;l.preconnects.forEach(Tb,b);l.preconnects.clear();var L=B.preconnectChunks;for(d=0;d<L.length;d++)b.push(L[d]);
L.length=0;l.fontPreloads.forEach(Tb,b);l.fontPreloads.clear();l.precedences.forEach(Zb,b);l.scripts.forEach(Tb,b);l.scripts.clear();l.explicitStylesheetPreloads.forEach(Tb,b);l.explicitStylesheetPreloads.clear();l.explicitScriptPreloads.forEach(Tb,b);l.explicitScriptPreloads.clear();l.explicitOtherPreloads.forEach(Tb,b);l.explicitOtherPreloads.clear();var A=B.preloadChunks;for(d=0;d<A.length;d++)b.push(A[d]);A.length=0;var P=B.hoistableChunks;for(d=0;d<P.length;d++)b.push(P[d]);P.length=0;var v=
a.clientRenderedBoundaries;for(c=0;c<v.length;c++){var D=v[c];l=b;var w=a.responseState,wa=D.id,ma=D.errorDigest,ca=D.errorMessage,V=D.errorComponentStack,Q=0===w.streamingFormat;Q?(l.push(w.startInlineScript),0===(w.instructions&4)?(w.instructions|=4,l.push('$RX=function(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};;$RX("')):l.push('$RX("')):l.push('<template data-rxi="" data-bid="');
if(null===wa)throw Error("An ID must have been assigned before we can complete the boundary.");l.push(wa);Q&&l.push('"');if(ma||ca||V)if(Q){l.push(",");var xa=Lb(ma||"");l.push(xa)}else{l.push('" data-dgst="');var ya=q(ma||"");l.push(ya)}if(ca||V)if(Q){l.push(",");var za=Lb(ca||"");l.push(za)}else{l.push('" data-msg="');var Aa=q(ca||"");l.push(Aa)}if(V)if(Q){l.push(",");var da=Lb(V);l.push(da)}else{l.push('" data-stck="');var E=q(V);l.push(E)}if(Q?!l.push(")\x3c/script>"):!l.push('"></template>')){a.destination=
null;c++;v.splice(0,c);return}}v.splice(0,c);var ea=a.completedBoundaries;for(c=0;c<ea.length;c++)if(!te(a,b,ea[c])){a.destination=null;c++;ea.splice(0,c);return}ea.splice(0,c);var M=a.partialBoundaries;for(c=0;c<M.length;c++){var fa=M[c];a:{v=a;D=b;v.resources.boundaryResources=fa.resources;var ha=fa.completedSegments;for(w=0;w<ha.length;w++)if(!ue(v,D,fa,ha[w])){w++;ha.splice(0,w);var Ba=!1;break a}ha.splice(0,w);Ba=Rb(D,fa.resources,v.responseState)}if(!Ba){a.destination=null;c++;M.splice(0,c);
return}}M.splice(0,c);var ia=a.completedBoundaries;for(c=0;c<ia.length;c++)if(!te(a,b,ia[c])){a.destination=null;c++;ia.splice(0,c);return}ia.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&(a.flushScheduled=!1,a=a.responseState,a.hasBody&&(b.push("</"),b.push("body"),b.push(">")),a.htmlChunks&&(b.push("</"),b.push("html"),b.push(">")),b.push(null))}}
function cc(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;pe(a,b)}}function ve(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{pe(a,b)}catch(c){ee(a,c),fe(a,c)}}}
function we(a,b){try{var c=a.abortableTasks;if(0<c.size){var d=void 0===b?Error("The render was aborted by the server without a reason."):b;c.forEach(function(e){return oe(e,a,d)});c.clear()}null!==a.destination&&pe(a,a.destination)}catch(e){ee(a,e),fe(a,e)}}function xe(){}
function ye(a,b,c,d,e){var f=!1,g=null,h="",k=!1,m=bc();a=ae(a,m,ec(m,c,b?b.identifierPrefix:void 0,e),fc(),Infinity,xe,void 0,function(){k=!0},void 0,void 0);a.flushScheduled=null!==a.destination;de(a);we(a,d);ve(a,{push:function(t){null!==t&&(h+=t);return!0},destroy:function(t){f=!0;g=t}});if(f&&g!==d)throw g;if(!k)throw Error("A component suspended while responding to synchronous input. This will cause the UI to be replaced with a loading indicator. To fix, updates that suspend should be wrapped with startTransition.");
return h}function ze(a,b){a.prototype=Object.create(b.prototype);a.prototype.constructor=a;a.__proto__=b}var Ae=function(a){function b(){var d=a.call(this,{})||this;d.request=null;d.startedFlowing=!1;return d}ze(b,a);var c=b.prototype;c._destroy=function(d,e){we(this.request);e(d)};c._read=function(){this.startedFlowing&&ve(this.request,this)};return b}(ka.Readable);function Be(){}
function Ce(a,b){var c=new Ae,d=bc(),e=ae(a,d,ec(d,!1,b?b.identifierPrefix:void 0),fc(),Infinity,Be,function(){c.startedFlowing=!0;ve(e,c)},void 0,void 0);c.request=e;e.flushScheduled=null!==e.destination;de(e);return c}exports.renderToNodeStream=function(a,b){return Ce(a,b)};exports.renderToStaticMarkup=function(a,b){return ye(a,b,!0,'The server used "renderToStaticMarkup" which does not support Suspense. If you intended to have the server wait for the suspended component please switch to "renderToPipeableStream" which supports Suspense on the server')};
